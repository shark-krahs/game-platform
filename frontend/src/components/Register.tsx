...
import {Alert, Button, Form, type FormProps, Input, Space, Typography} from 'antd';
import {ClockCircleOutlined, LockOutlined, MailOutlined, UserOutlined} from '@ant-design/icons';
