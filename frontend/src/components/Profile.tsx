...
import {Alert, App, Button, Card, Form, type FormProps, Input, Select, Space, Steps, Typography,} from 'antd';
import {GlobalOutlined, LockOutlined, PlayCircleOutlined, StarOutlined, UserOutlined,} from '@ant-design/icons';
